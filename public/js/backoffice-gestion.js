document.addEventListener('DOMContentLoaded', ()=>
{
    ...
    const fetch_url = BASE_URL+"?c=Backoffice&m=obtenerReservas";
    ...
    .then(data => 
    {
       // Crear una tabla HTML
        ...
        const encabezados = ["Número de Reserva", "Código de Asiento", "ID de Omnibus", "ID de Servicio", "Fecha de Reserva"];
        ...
        data.forEach(reserva => 
        {
            ...
            const celdas = [reserva.NumReserva, reserva.CodAsiento, reserva.IdOmnibus, reserva.IdServicio, reserva.Fecha_Reserva];
