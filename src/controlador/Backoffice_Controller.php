...
class Backoffice_Controller extends Controlador
{
  public function __construct()
  {
    ...
    if (!$es_sesion_valida) header("Location: " . URL . "index.php?c=Login&m=vista_backoffice_login");
  }
  #region rutas
  ...
  private function validarPayloadLinea($datos)
  {
    ...
    if ($this->validarValorVacio($datos["id_servicio"]) && !$this->validarNumero($datos["id_servicio"])) {
    ...
    if ($this->validarValorVacio($datos["id_ruta"]) && !$this->validarNumero($datos["id_ruta"])) {
  ...
  public function obtenerReservas()
  {
    ...
    echo BackOffice::obtenerReservas();
    //return BackOffice::obtenerReservas();
  }
  ...
  public function obtenerUsuarios()
  {
    ...
    echo BackOffice::obtenerUsuarios();
    //return BackOffice::obtenerReservas();
  }
  ...
  public function cargarNoticias()
  {
    ...
    echo BackOffice::cargarNoticias();
    //return BackOffice::obtenerReservas();
  }
  ...
  public function crearNoticia()
  {
    ...
    echo BackOffice::crearNoticia($Titulo, $Descripcion, $Imagen, $Fecha, $ID_Adm);
    //return BackOffice::obtenerReservas();
  }
  ...
  public function eliminarLinea()
  {
    ...
    try {
      ...
      if (!$this->validarValorVacio($id)) {
        $errores["id"] = "El campo id es obligatorio";
      }

      if (count($errores) > 0) return $this->respuestaError($errores);

      Backoffice::eliminarLinea($id);
