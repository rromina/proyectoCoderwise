...
<body>
    <?php if(isset($_SESSION['error_login']) && $_SESSION['error_login'] === "errorUserCode:3303") {echo '<script>Swal.fire({title: "login inválido!",text: "Usted intengo ingresar con datos corruptos o inválidos desde el panel login. Por favor verifique.",icon: "error"});</script>';}?>
